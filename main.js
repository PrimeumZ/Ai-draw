...
some_array = quick_draw_data_set[random_number];
console.log(random_number,quick_draw_data_set);
document.getElementById("Sketch").innerHTML = "Sketch to be drawn is : "+some_array;
...
function draw(){
    check_sketch()
    if(drawn_sketch == some_array){
        answer_holder = "set";
        score = score+1;
        document.getElementById("score").innerHTML = "Timer :"+timer_counter 
    }
}
